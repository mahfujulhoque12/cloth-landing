...
const ByeNow = () => {
  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className="my-10 max-w-2xl mx-auto  bg-[var(--badge-bg)] p-6 rounded-lg shadow-md border border-gray-300">
        <h2 className="text-2xl font-bold mb-4 text-center text-[#FFA725]">Buy Your Food</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[var(--btn-bg)] hover:bg-[#463d25] text-white font-semibold py-2 rounded-md transition cursor-pointer"
          >
